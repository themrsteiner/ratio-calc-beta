  ...
  return (
    <section className="panel wide weekOverview">
      <div className="hero" style={{ padding: '16px', borderRadius: '18px', marginBottom: '12px', position: 'relative', background: 'var(--color-primary)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', color: '#fff', width: '100%', gap: '12px', flexWrap: 'wrap' }}>
          <div style={{ minWidth: 0, flex: '1 1 280px' }}>
            <h1 style={{ fontSize: '2rem', marginBottom: 0, lineHeight: 1.1, color: '#fff', overflowWrap: 'anywhere' }}>{activeWeek.weekLabel}</h1>
          </div>
          <div style={{ textAlign: 'right', display: 'flex', flexDirection: 'column', gap: '2px', flex: '0 1 auto' }}>
